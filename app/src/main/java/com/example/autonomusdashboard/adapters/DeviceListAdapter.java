package com.example.autonomusdashboard.adapters;
...
import com.example.autonomusdashboard.MainActivity;
import com.example.autonomusdashboard.R;
import com.example.autonomusdashboard.models.DeviceInfoModel;
...
public class DeviceListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.device_list_layout, parent, false);
